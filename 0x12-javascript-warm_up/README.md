...
- You are not allowed to use `var`
	...
	```sh
	ayomide@Kazzywiz:~/alx-higher_level_programming/0x12-javascript-warm_up$ ./11-second_biggest.js 
	0
	ayomide@Kazzywiz:~/alx-higher_level_programming/0x12-javascript-warm_up$ ./11-second_biggest.js 1
	0
	ayomide@Kazzywiz:~/alx-higher_level_programming/0x12-javascript-warm_up$ ./11-second_biggest.js 4 2 5 3 0 -3
	4
	ayomide@Kazzywiz:~/alx-higher_level_programming/0x12-javascript-warm_up$ 
	```
...
console.log(myVar);
ayomide@Kazzywiz:~/alx-higher_level_programming/0x12-javascript-warm_up$ ./100-main.js 
333
```
